...
def display_board(board)
  ...
  #create_code()  
    ...
    def match()
      ...
      if @color_one == @code[1] || @color_one == @code[2] || @color_one == @code[3]
        puts "match"
      end
      if @color_two == @code[0] || @color_two == @code[2] || @color_two == @code[3]
        puts "match"
      end
      if @color_three == @code[0] || @color_three == @code[1] || @color_three == @code[3]
        puts "match"
      end
      if @color_four == @code[0] || @color_four == @code[1] || @color_four == @code[2]
        puts "match"
      end
