...
def match()
    ...
    if (@color_one != @color_two || @color_one != @color_three || @color_one != @color_four) &&(@color_one == @code[1] || @color_one == @code[2] || @color_one == @code[3])
    @color_matches += 1
    puts "match"
    end
    if (@color_two != @color_one || @color_two != @color_three || @color_two != @color_four) && (@color_two == @code[0] || @color_two == @code[2] || @color_two == @code[3])
    @color_matches += 1
    puts "match"
    end
    if (@color_three != @color_one || @color_three != @color_two || @color_three != @color_four) && (@color_three == @code[0] || @color_three == @code[1] || @color_three == @code[3])
    @color_matches += 1
    puts "match"
    end
